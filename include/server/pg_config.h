...
#define CONFIGURE_ARGS " '--enable-depend' '--enable-cassert' '--enable-debug' 'CFLAGS=-ggdb -O0'"
...
#define PG_VERSION_STR "PostgreSQL 14.0 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.3.0-1ubuntu1~22.04) 11.3.0, 64-bit"
